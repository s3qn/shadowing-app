...
- Run the task's verification commands, and always `npx tsc --noEmit -p tsconfig.json` for client changes and `node ~/.claude/skills/slop-check/scripts/scan.js`. Both must be clean before you report.
