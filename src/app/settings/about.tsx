    ...
    <SafeAreaView edges={['bottom']} style={StyleSheet.flatten([styles.fill, { backgroundColor: tide.sky[0] }])}>
      <ScrollView contentContainerStyle={styles.list}>
        <SettingsSection title="App">
          <SettingsRow label="Version" value={version} last />
        </SettingsSection>
        ...
        <SettingsSection
          ...
          <SettingsRow label="Voice synthesis" value="VOICEVOX" />
          <SettingsRow label="Speech recognition" value="faster-whisper" last />
        </SettingsSection>

        <SettingsSection title="Licences" footnote="Every open source dependency keeps its own licence, unmodified.">
          <SettingsRow label="Open source licences" value="See package.json" last />
        </SettingsSection>
      </ScrollView>
    </SafeAreaView>
  );
